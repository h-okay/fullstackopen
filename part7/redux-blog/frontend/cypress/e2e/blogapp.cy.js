describe("Blog app", function () {
  ...
  describe("When logged in", function () {
    ...
    it("A blog can be created", function () {
      ...
      cy.get("#title").type("Youre NOT gonna need it");
      ...
      cy.contains("Youre NOT gonna need it");
  ...
  describe("When a blog has been created", function () {
    ...
    it("the creator can delete it", function () {
      ...
      cy.contains("removed");
      cy.wait(5000);
      cy.get("html").should("not.contain", "Youre NOT gonna need it");
    });
  ...
  describe("When there exists several blogs", function () {
    ...
    it("those are ordered by the likes", function () {
      ...
      cy.get("@like2").click();
      cy.wait(1000);
      cy.contains(blogs[2].title).contains("likes 4");
